// ninfer::ops - hq-e8-2b small-T partial-kernel route, 27B geometry. Split from
...
template void gqa_small_t_partial_hq<Gqa27Geometry, GqaAppendInput>(
    ...
    cudaStream_t);
template void gqa_small_t_partial_hq<Gqa27Geometry, GqaCachedInput>(
