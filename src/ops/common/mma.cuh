...
// FP16-accumulate variant of the m16n8k16 f16 MMA (GeForce doubles this rate): the accumulator is
// two b32 registers holding four f16 values in the same fragment positions as an f32 form would
// occupy (reg0 = row groupID cols 2*lid/2*lid+1, reg1 = row groupID+8).
